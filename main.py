...
def get_router_connections(router_ip: str) -> list[dict[str, str, str, str]]:
    load_dotenv()
...
def build_map(url: str, token: str, map: dict, connections: list):
    map_hosts = []
    ...
    for connection in connections:
        ...
        if local_host_id not in map_hosts:
            ...
            map['selements'].append(local_host)
        ...
        if remote_host_id not in map_hosts:
            ...
            map['selements'].append(remote_host)
...
if __name__ == '__main__':
    ...
    routers_info = get_router_connections(R2)
    ...
    build_map(ZABBIX_URL, ZABBIX_TOKEN, zabbix_map, routers_info)
